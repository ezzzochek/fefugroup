...
% !TeX document-id = {975f8a47-d53a-44c0-bfb2-23565aa06549}
% !TeX program = xelatex
% !TeX encoding = UTF-8
% !TeX spellcheck = ru_RU
% !TeX TXS-program:compile=txs:///xelatex/[--shell-escape]|txs:///view-pdf
% !TeX TXS-program:bibliography = txs:///biber
\documentclass[ {{master thesis}}, draught ]{fefudoc} %Убрать "draught" в финальной версии ВКР
...
\superintendent{доктор физико-математических наук}{профессор}{директор департамента ЭТиП}{Жаннов Захар Ильич}
...
\include{./главы примеров ВКР/аннотация}
\include{./главы примеров ВКР/аннотация на английском}
\include{./главы примеров ВКР/введение}
\include{./главы примеров ВКР/1}
\include{./главы примеров ВКР/2}
\include{./главы примеров ВКР/3}
\include{./главы примеров ВКР/4}
\include{./главы примеров ВКР/заключение}
\printbibliography
\tableofcontents
\appendix
\include{./главы примеров ВКР/приложение с таблицей РПД}
\include{./главы примеров ВКР/приложение с логической диаграммой и горизонтальной ориентацией}
\include{./главы примеров ВКР/приложение с усилителем и без номера}
\end{document}
